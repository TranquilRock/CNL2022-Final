    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-10 ml-sm-auto col-lg-10">
                ...
                <form name="radius-login" method="get" action="process_login.php">
                    ...
                    <a class="btn btn-outline-primary" role="button" href="register.php<?= "?uamip=" . $_GET['uamip'] . "&uamport=" . $_GET['uamport'] ?>">Register</a>
                </form>
            </main>
