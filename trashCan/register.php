            ...
            <main role="main" class="col-md-10 ml-sm-auto col-lg-10">
                ...
                <form name="radius-login" method="POST" action="register.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="re-password" id="re-password" placeholder="Re-type password">
                    </div>
                    <button type="submit" class="btn btn-primary">Submit</button>
                    <a class="btn btn-outline-primary" role="button" href="login.php<?= "?uamip=" . $_GET['uamip'] . "&uamport=" . $_GET['uamport'] ?>">Back</a>
                </form>
            </main>
